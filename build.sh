...
echo "🚀 Preparing modular_flutter for publishing..."
echo ""
...
dart run modular_flutter create TestModule --force 2>/dev/null || true
dart run modular_flutter list > /dev/null 2>&1 && echo -e "${GREEN}✅ CLI works${NC}" || echo -e "${YELLOW}⚠️  CLI test skipped (modules directory may not exist)${NC}"
# Cleanup
